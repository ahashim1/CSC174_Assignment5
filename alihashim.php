...
<body>
	...
	<div class="container">
		<div class="wrapper">
			...
			<div class="two">
					<img class="responsive-img" src="images/ali.jpg" alt="Ali Hashim">
			</div><!-- two -->
	...
	<main>
		...
		<section>
			<h3 class="portfolio">University of Rochester Optics Lab Teaching Assistant</h3>
		...
		<section>
			<h3 class="portfolio">Laboratory for Laser Energetics Research Intern</h3>
		...
		<div class="five card-panel blue-grey lighten-2 z-depth-0">
			...
			<section>
				<h3 class="portfolio">Computer Skills</h3>
				<ul>
			...
			<section>
				...
				<h3 class="portfolio">Optics Skills</h3>
				<ul>
