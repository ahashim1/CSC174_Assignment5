	...
	<div class="container">
		...
		<div class="row"><!-- row 1 -->
			<div class="col s12 m8 card-panel blue-grey lighten-2 z-depth-0">
				<header>
					<h1 class="center-align aaron">Aaron Raymond</h1>
				</header>
			...
			<div class="col s12 m4">
				<img class="responsive-img" src="images/aaron.jpg" alt="Aaron Raymond">
			</div>
		...
		<div class="row"><!-- row 2 -->
			...
			<div class="col s12 m8 card-panel blue-grey lighten-2 z-depth-0">
				...
				<main>
					...
					<section>
					<h3 class="portfolio">Web Design - Cheyanna's Champions 4 Children</h3>
					...
					<section>
						<h3 class="portfolio">Photography - University of Rochester</h3>
					...
					<section>
						<h3 class="portfolio">IT Consultant - Dallas Computer Solutions (DCS)</h3>
			...
			<div class="s12 m4 card-panel blue-grey lighten-2 z-depth-0">
				<!-- My Extracurriculars -->
				<section>
