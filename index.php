...
<body>
	...
	<div class="row"><!-- row 1 -->
		<div class="card-panel blue-grey lighten-2 z-depth-0 col s8 push-s4">
			<h2>John Denzer</h2>
		...
		<div class="col s4 pull-s8 center-align">
			<img src="images/baseball.png" alt="Baseball player hitting a ball" height="200" width="200">
		</div>
	</div><!-- row 1 -->

	<div class="row"><!-- row 2 -->
		<div class="card-panel blue-grey lighten-2 z-depth-0 col s8 ">
			<h2>Ali Hashim</h2>
	...
	<div class="row"><!-- row 3 -->
		<div class="card-panel blue-grey lighten-2 z-depth-0 col s8 push-s4">
			...
			<a class="btn light-blue lighten-2 z-depth-0" href="alihashim.php">Read more about Aaron</a>
		</div>
		<div class="col s4 pull-s8 center-align">
